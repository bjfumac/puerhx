...
@:jsRequire("csharp", "UnityEngine.Debug") extern class Debug extends csharp.system.Object {
	...
	public static function DrawLine(start:Vector3, end:Vector3, color:Color, duration:Float):Void;
	...
	@:overload(function(logType:LogType, logOptions:LogOption, context:Object, format:String, args:haxe.extern.Rest<Dynamic>):Void {})

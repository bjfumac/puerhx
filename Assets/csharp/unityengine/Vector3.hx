...
@:jsRequire("csharp", "UnityEngine.Vector3") extern class Vector3 extends csharp.system.ValueType_ {
	...
	@:overload(function(other:Vector3):Bool {})
	...
	@:overload(function(current:Vector3, target:Vector3, currentVelocity:csharp.DollarRef<Vector3>, smoothTime:Float, maxSpeed:Float,
		deltaTime:Float):Vector3 {})

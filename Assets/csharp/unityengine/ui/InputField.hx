...
@:jsRequire("csharp", "UnityEngine.UI.InputField") extern class InputField extends Selectable {
	...
	public var onValueChange : csharp.unityengine.ui.inputfield.OnChangeEvent;
	...
	public function ScreenToLocal(screen:csharp.unityengine.Vector2):csharp.unityengine.Vector2;
